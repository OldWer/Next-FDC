...
<br/>The Next-FDC also works with regular ZX Spectrum +2A (and some clones, such as Sizif-512 and Harlequin 128), and I fully expect it to work with ZX Next issue 3 also (there is just a little bit of redundancy, because in this cases the controller will create signals which are already present).
